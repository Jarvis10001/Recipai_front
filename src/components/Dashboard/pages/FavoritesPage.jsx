...
const FavoritesPage = () => {
  ...
  const fetchFavoriteRecipes = async () => {
    try {
      ...
      const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/recipes/favorites`, {
        headers: {
  ...
  const handleRemoveFavorite = async (recipeId) => {
    try {
      ...
      const response = await axios.delete(
        `${import.meta.env.VITE_BACKEND_URL}/api/recipes/favorites/${recipeId}`,
        {
          headers: {
            'Authorization': `Bearer ${token}`
          }
  ...
  const handleViewRecipe = async (recipe) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_BACKEND_URL}/api/recipes/details`,
        { recipe },
        {
          headers: {
            'Authorization': `Bearer ${token}`,
