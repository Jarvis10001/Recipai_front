...
import RecipeModelPage from './pages/RecipeModelPage';
...
const DashboardContent = () => {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className={`flex-1 transition-all duration-300 ${
        ...
        <main className="p-6">
          <Routes>
            ...
            <Route path="/recipe-model" element={<RecipeModelPage />} />
            <Route path="/recipes/view" element={<RecipeDetailPage />} />
      ...
      <AnimatePresence>
        {showBMICalculator && (
          <BMICalculator onClose={handleBMICalculator} />
        )}
      </AnimatePresence>
    </div>
  );
