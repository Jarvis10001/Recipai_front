...
const navItems = [
  ...
  { name: "Recipe Model", icon: "ri-magic-line", path: "/dashboard/recipe-model" },
  ...
  { name: "Stockup", icon: "ri-store-2-line", path: "/dashboard/leftovers" },
  { name: "Nutrition Tracker", icon: "ri-line-chart-line", path: "/dashboard/nutrition" },
